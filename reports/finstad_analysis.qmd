...
```{r}
# Define stress scenarios as per-asset shock magnitudes (instantaneous price shocks)
stress_scenarios <- tribble(
  ~Scenario,                       ~TEL,  ~MER,  ~AEV,  ~NVDA, ~META, ~BTC,
  "2020 COVID Crash",             -0.15, -0.18, -0.20, -0.12, -0.10, -0.35,
  "2022 Crypto Winter",           -0.05, -0.03, -0.04, -0.15, -0.10, -0.60,
  "Fed Rate Hike Shock",          -0.08, -0.06, -0.07, -0.10, -0.08, -0.15,
  "Tech Sector Selloff",          -0.02, -0.01, -0.03, -0.25, -0.20, -0.10,
  "Hypothetical Black Swan",      -0.25, -0.25, -0.25, -0.30, -0.30, -0.50
)
